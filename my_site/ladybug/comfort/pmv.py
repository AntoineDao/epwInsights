...
class PMV(ComfortModel):
    ...
    def fromEPWFile(cls, epwFileAddress, metRate=1.1, cloValue=0.85,
        ...
        return cls(epwData.dryBulbTemperature.values, epwData.dryBulbTemperature.values, epwData.windSpeed.values, epwData.relativeHumidity.values, [metRate], [cloValue], [externalWork])
